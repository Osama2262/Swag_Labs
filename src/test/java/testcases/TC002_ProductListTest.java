...
public class TC002_ProductListTest extends BaseTest {
    ...
    @Test(description = "Validating sort option")
    @Description("verify that the sorting option displays products in the correct order")
